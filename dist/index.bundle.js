...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"Gameboard\": () => (/* binding */ Gameboard)\n/* harmony export */ });\n/* harmony import */ var _display_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./display.js */ \"./src/display.js\");\n/* harmony import */ var _ship_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./ship.js */ \"./src/ship.js\");\n\n\n\nconst Gameboard = () => {\n    // const computerBoats = compBoats;\n    // const playerBoats = plrBoats;\n    const ComputerBoard = () => {\n        const setLocation = (boat, ...arr) => {\n            const location = arr;\n            return boat.shipLocation(location, _ship_js__WEBPACK_IMPORTED_MODULE_1__.computerBoats);\n        }\n        const makeBoard = () => {\n            ;(0,_display_js__WEBPACK_IMPORTED_MODULE_0__.generateBoard)('computer-board');\n        }\n        const receiveAttack = (hitSpot) => {\n            let compMissedShots = [];\n            let hitBoat;\n            const boatHit = _ship_js__WEBPACK_IMPORTED_MODULE_1__.computerBoats.filter(boat => {\n                boat.coordinates.forEach(node => {\n                    if(node === hitSpot) {\n                        hitBoat = boat;\n                    }\n                    else {\n                        return;\n                    }\n                })\n                return hitBoat === boat;\n            });\n    \n            if(boatHit.length === 0) {\n                //record coordinates of missed shot\n                compMissedShots.push(hitSpot);\n                return compMissedShots;\n                //record missed shot on board\n            }\n            const name = boatHit[0].boatName;\n            const length = boatHit[0].length;\n            //send hit coordinates to isHit\n            return (0,_ship_js__WEBPACK_IMPORTED_MODULE_1__.Ship)(name, length).isHit(hitSpot, _ship_js__WEBPACK_IMPORTED_MODULE_1__.computerBoats);\n        }\n\n        return {\n            setLocation,\n            receiveAttack,\n            makeBoard\n        }\n    }\n    const PlayerBoard = () => {\n        const setLocation = (boat, ...arr) => {\n            const location = arr;\n            return boat.shipLocation(location, _ship_js__WEBPACK_IMPORTED_MODULE_1__.playerBoats);\n        }\n        const makeBoard = () => {\n            ;(0,_display_js__WEBPACK_IMPORTED_MODULE_0__.generateBoard)('player-board');\n        }\n        const receiveAttack = (hitSpot) => {\n            let playerMissedShots = [];\n            let hitBoat;\n            const boatHit = _ship_js__WEBPACK_IMPORTED_MODULE_1__.playerBoats.filter(boat => {\n                boat.coordinates.forEach(num => {\n                    if(num === hitSpot) {\n                        hitBoat = boat;\n                    }\n                    else {\n                        return;\n                    }\n                })\n                return hitBoat === boat;\n            });\n            \n            if(boatHit.length === 0) {\n                //record coordinates of missed shot\n                playerMissedShots.push(hitSpot);\n                return playerMissedShots;\n                //record missed shot on board\n            }\n\n            //send hit coordinates to isHit\n            return boatHit[0].isHit(hitSpot, _ship_js__WEBPACK_IMPORTED_MODULE_1__.playerBoats);\n        }\n        return {\n            setLocation,\n            receiveAttack,\n            makeBoard\n        }\n    }\n    return {\n        ComputerBoard,\n        PlayerBoard,\n    }\n}\n\n\n\n//# sourceURL=webpack://battleship/./src/gameboard.js?");
...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"Players\": () => (/* binding */ Players)\n/* harmony export */ });\n/* harmony import */ var _gameboard_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./gameboard.js */ \"./src/gameboard.js\");\n\n\nfunction Players() {\n    let isPlayer = true;\n    const Computer = () => {\n        const _randomNum = () => {\n            let num = Math.floor(Math.random() * (100-1) + 1);\n            if(occupiedSpots.indexOf(num) !== -1) {\n                _randomNum();\n            }\n            return num;\n        };\n        const compAttack = () => {\n            return (0,_gameboard_js__WEBPACK_IMPORTED_MODULE_0__.Gameboard)().PlayerBoard().receiveAttack(_randomNum())\n        };\n        isPlayer = true;\n        return {\n            compAttack\n        }\n    }\n\n    const Player = () => {\n        const playerAttack = (target) => {\n            return (0,_gameboard_js__WEBPACK_IMPORTED_MODULE_0__.Gameboard)().ComputerBoard().receiveAttack(target);\n        };\n        isPlayer = false;\n        return {\n            playerAttack\n        }\n    }\n\n    const playerTurn = (target) => {\n        return (isPlayer ? Player().playerAttack(target) : Computer().compAttack()); \n    }\n    return {\n        Computer,\n        Player,\n        playerTurn\n    }\n}\n\n\n\n//# sourceURL=webpack://battleship/./src/player.js?");
